<script>
    $(document).ready(function() {
        ...
        $.ajax({
			type: "GET",
			url: "<?= base_url('project/options/') ?>",
			success: function(data){
				var opts = $.parseJSON(data);
				$.each(opts, function(i, d) {
					$("#project_id").append('<option value="'+d.id+'">'+d.text+'</option>');
				});
			}
        });
        ...
        var table = $("#dtTable").dataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "<?= base_url('kriteria/list_data') ?>", 
                "type": "POST"
            },
            responsive: true,
            pageLength: 5,
